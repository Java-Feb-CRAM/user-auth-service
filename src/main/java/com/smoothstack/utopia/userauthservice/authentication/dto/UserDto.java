...
public class UserDto {
  ...
  @Size(
    min = 10,
    max = 16,
    message = "Phone number must be between 10 to 16 characters."
  )
  ...
  @Size(
    min = 1,
    max = 32,
    message = "Family name must be between 1 and 32 characters."
  )
  ...
  @Size(
    min = 1,
    max = 32,
    message = "Given name must be between 1 and 32 characters."
  )
  ...
  @Size(
    min = 8,
    max = 32,
    message = "Cannot match password with invalid size of characters."
  )
